// HeaderDetails.js
export default function HeaderDetails({ show }) {
    return (
        <div style={{ position: 'relative', overflow: 'hidden', backgroundColor: '#2b2b2b', padding: '40px', borderRadius: '10px' }}>
            {/* Image de fond */}
            <div
                style={{
                    position: 'absolute',
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', position: 'relative', zIndex: 1, gap: '20px' }}>
                ...
                <div style={{ flex: '0 0 auto' }}>
                    ...
                    />
                    {/* Bouton streaming */}
                    <div style={{ marginTop: '20px', backgroundColor: '#1f80e0', borderRadius: '10px', textAlign: 'center', padding: '10px', color: '#fff', fontWeight: 'bold', cursor: 'pointer' }}>
                        <a href="#" style={{ color: '#fff', textDecoration: 'none' }}>Regarder maintenant</a>
                    </div>
                </div>
