            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', position: 'relative', zIndex: 1, padding: '20px' }}>
                    ...
                    <div style={{ marginLeft: '20px' }}>
                        <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold' }}>{movie.title} ({new Date(movie.release_date).getFullYear()})</h1>
                        <p style={{ fontSize: '1.2rem', fontStyle: 'italic' }}>{movie.tagline}</p>
